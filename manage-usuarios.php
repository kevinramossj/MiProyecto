...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
															...
															<td><?php echo htmlentities($result->negocio);?></td>
                                                          
<td>
<a href="edit-usuario.php?id=<?php echo htmlentities($result->id);?>" class="btn btn-info"><i class="fa fa-edit" title="Editar registro"></i> </a> 
