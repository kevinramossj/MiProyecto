...
<html lang="es">
  ...
  <title>MiProyecto - Sistema de Gestión</title>
   ...
   <body>
      <header>
            ...
            <div class="container">
               <div class="top-sec d-grid">
                     <ul  class="d-flex list-unstyled m-0 left-info">
                        <li>
                           <span class="fa fa-phone text-white me-2"></span><a href="tel:+(91) 000 0000">(+91) 0000 0000 00</a>
                        </li>
                        <li class="">
                           <a href="#help" class="d-md-block d-none">Help Center</a>
                        </li>
                        <li class="">
                           <a href="mailto:mayuri.infospace@gmail.com" class="d-md-block d-none">mayuri.infospace@gmail.com</a>
                        </li>
                     </ul>
                  <div>
         ...
         <nav class="navbar navbar-expand-lg bg-white">
          <div class="container">
            <!-- Logo eliminado -->
            <!-- <a class="navbar-brand" href="#"><img src="" style="height: 70px"></a> -->
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="find-result.php">Estudiantes</a>
                </li>
                <li class="nav-item">
            ...
            <div class="item">
              <div class=" banner-view banner-top1 d-flex align-items-center justify-content-center text-center">
                <div class="banner-info-bg">
                  ...
                  <h5>Sistema de Gestión de Resultados</h5>
                  <p class="mt-md-4 mt-3">Obtén lo mejor para optimizar las operaciones de tu equipo y crear experiencias UI/UX sorprendentes.</p>
                  <a class="btn btn-style btn-danger mt-sm-5 mt-4 mr-2" href="">Más información</a>
                </div>
              </div>
            </div>
             <div class="item">
              <div class=" banner-view banner-top2 d-flex align-items-center justify-content-center text-center">
                <div class="banner-info-bg">
                  <h6>Somos creativos</h6>
                  <h5>Empresa de servicios TI</h5>
                  <p class="mt-md-4 mt-3">Optimizamos las operaciones de tu equipo para crear experiencias UI/UX sobresalientes.</p>
                  <a class="btn btn-style btn-danger mt-sm-5 mt-4 mr-2" href="">Más información</a>
                </div>
              </div>
            </div>
...
<?php }} ?>
          ...
          <div class="container py-md-5 py-sm-4 py-2">
              <div class="row align-items-center">
                  ...
                  <div class="col-lg-5 text-lg-end">
                      <a href="#learn" class="btn btn-style btn-outline-dark mt-lg-0 mt-md-5 mt-4 me-2">Más información</a>
                      <a href="contact.html" class="btn btn-style btn-danger mt-lg-0 mt-md-5 mt-4">Contáctanos</a>
              </div>
            </div>
        </div>
      </section>
                ...
                <div class="col-lg-4 col-md-6 feature-grid">
                    <div class="feature-body service1"><a href="#url">
                            <div class="feature-img">
                                ...
                                </a><a href="#read" class="read mt-4 d-block">Leer más</a>
                            </div>
                        </div>
    ...
    <section class="customers py-md-4 py-3">
      ...
      <div class="owl-carousel owl-theme" id="customer">
        <!-- Los logos de clientes se mantienen ya que no son de la empresa -->
        <div class="item"><img src="assets/images/logo2.png"></div>
        <div class="item"><img src="assets/images/logo3.png"></div>
        <div class="item"><img src="assets/images/logo4.png"></div>
      </div>
    </div>
    </section>
<footer class="footer pt-5">
          <div class="container py-5">
            <div class="row footer-top-29">
              <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
                ...
                <p>Mayuri K. trabaja en PHP, PDO, Python y Laravel. Próximamente lanzará un curso en línea sobre proyectos PHP para principiantes. Puedes contactarla para el desarrollo de proyectos, ya sean académicos o comerciales.</p>
              ...
              <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5">
                ...
                <p>Dirección: Mayuri Freelancer, 101 building Number, #2214 galaxy street, INDIA - 111111.</p>
                <p class="mt-2">Teléfono: <a href="tel:(+91) 9090909090">(+91)9090909090</a></p>
                <p class="mt-2">Correo electrónico: <a href="mailto:info@result.com">info@result.com</a></p>
                <p class="mt-2">Soporte: <a href="mailto:info@result.com">info@result.com</a></p>
              </div>
            </div>
          </div>
        <!-- copyright -->
        <section class="w3l-copyright text-center">
          <div class="container">
            <p class="copy-footer-29">Copyright &copy; Sistema de Gestión de Resultados <?php echo date('Y');?></p>
          </div>
      </section>
      </footer>
