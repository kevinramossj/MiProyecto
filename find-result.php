...
<html lang="es">
    ...
    <title>Resultados - MiProyecto</title>
            ...
            <div class="login-bg-color">
                <div class="row">
                    ...
                    <img style="height: 70px" src="assets/images/footer-logo.png"></a>
                                    <h3 class="text-white">Sistema de Resultados Escolares</h3>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post" class="admin-login">
                                	<div class="form-group">
                                		<label for="rollid" class="control-label">Ingrese su número de matrícula</label>
                                        <input type="text" class="form-control" id="rollid" placeholder="Ingrese su número de matrícula" autocomplete="off" name="rollid">
                                 	</div>
                               <div class="form-group">
